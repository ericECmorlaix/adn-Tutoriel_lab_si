# SCOPPY, un oscilloscope avec Raspberry Pi Pico

Il s'agit d'un oscilloscope basse fréquence qui peut mesurer des tensions allant jusqu’à 3,3V. C'est suffisant pour nos activités impliquant la modulation de largeur d’impulsion (PWM), la caractérisation de capteurs, l’analyse de la logique numérique.
...
> [APK](https://apkpure.com/scoppy-oscilloscope/xyz.fhdm.scoppy){target=_blank}
